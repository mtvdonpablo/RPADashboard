...
const CostSavingsDetails = ({ items = [] }) => {
          ...
          <Popover.Content bg="gray.800" rounded="lg" shadow="xl" w="100%" >
            ...
            <Popover.Body>
              <VStack align="start" spacing={1}>
                {items.map(({ ProjectName, costSavings }) => (
                  <Text color="white" key={costSavings}>
                    {ProjectName}: ${costSavings}
                  </Text>
                ))}
              </VStack>
            </Popover.Body>
...
export default CostSavingsDetails;
